This project is a simple boilerplate for [React](https://github.com/facebook/react), [Redux](https://github.com/reduxjs/redux) and [Redux-Thunk](https://github.com/reduxjs/redux-thunk). It consists of 3 different branches as follows:
